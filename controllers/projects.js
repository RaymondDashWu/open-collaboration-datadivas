...
module.exports = (app) => {
    ...
    app.get('/:category', (req, res) => {
      const superLongUnneccessaryVariableNameMaker = req.params.category.charAt(0).toUpperCase() + req.params.category.substring(1).toLowerCase();
      res.render(`${superLongUnneccessaryVariableNameMaker}/${req.params.category.toLowerCase()}.handlebars`);
    })
  }
